cordova.define("hcmobile-plugin-mqtt.CordovaMqTTPlugin", function(require, exports, module) {
/*
    ...
    if(url.length>0&&urgx.exec(url)!==null){
        if (cordova.platformId === "android") {
            ...
            client.onMessageArrived = function (payload) {
                ...
                if(router!==null){
                    if (args.routerConfig!==undefined) {
                        if (args.routerConfig.publishMethod!==undefined) { router[args.routerConfig.publishMethod](payload.destinationName,preparedPayload);
                        }
