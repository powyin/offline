cordova.define("hcmobile-plugin-dialogs.notification", function(require, exports, module) {
...
module.exports = {
    ...
    alert: function (message, completeCallback, title, buttonLabel) {
        argscheck.checkArgs('sFsS', 'notification.alert', arguments);
    ...
    confirm: function (message, resultCallback, title, buttonLabels) {
        argscheck.checkArgs('sFsA', 'notification.confirm', arguments);
        var _message = (typeof message === 'string' ? message : JSON.stringify(message));
    ...
    prompt: function (message, resultCallback, title, buttonLabels, defaultText) {
         argscheck.checkArgs('sFsAS', 'notification.prompt', arguments);
        var _message = (typeof message === 'string' ? message : JSON.stringify(message));
     ...
     */
    beep: function (count) {
        argscheck.checkArgs('N', 'notification.beep', arguments);
